 ...
 * @returns {Promise<{ [filename: string]: { blobURI: string } }>} The resources.
 */
 ...
 * 
 * @param {{ [filename: string]: { blobURI: string } }} resources The resources.
 */
function displayPage(resources) {
  document.body.innerHTML = "";
  for (const filename in resources) {
    const { blobURI } = resources[filename];
