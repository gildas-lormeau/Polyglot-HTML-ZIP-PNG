...
mkdir ./dist
npx single-file --dump-content --save-raw-page --remove-hidden-elements=false --compress-HTML=false --block-scripts=false --remove-unused-styles=false --remove-unused-fonts=false --remove-alternative-fonts=false --remove-alternative-medias=false --remove-alternative-images=false --compress-content=true --self-extracting-archive=true --embedded-image=./images/qr-code-mini.png --embed-pdf --embed-pdf-options='{ "pageRanges": "1-1", "paperWidth": 11, "paperHeight": 8.5 }' --insert-single-file-comment=false ./build/index.html > ./dist/presentation-polyglot-png-zip-html_en-EN.html
