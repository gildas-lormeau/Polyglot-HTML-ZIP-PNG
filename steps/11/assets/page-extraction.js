...
/* Text types and corresponding MIME types */
const TEXT_TYPES = {
    ".html": HTML_TYPE,
    ".css": "text/css",
    ".js": "text/javascript"
...
function resolveDependencies(resources) {
    DEPENDENCIES.forEach(([path, dependentPath]) => {
        ...
        if (dependentResource.blobURI) {
            ...
            /* Set the MIME type of the dependent data */
            ...
            /* Create a blob with the dependent data and MIME type */
            const dependentBlob = new Blob([dependentData],
                { type: dependentDataType });
            /* Create a URL for the dependent blob */
